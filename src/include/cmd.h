...
enum uart_protocol_cmd {
	...
	UFPP_D2H_SYNC_CMD	= 0x5A,	/* Single-Byte Device to Host	 */
					/* synchronization responce	 */
	UFPP_WRITE_CMD		= 0x07,	/* Write command and responce	 */
	UFPP_READ_CMD		= 0x1C,	/* Read command and responce	 */
	UFPP_READ_CRC_CMD	= 0x89,	/* Read CRC command and responce */
	UFPP_FCALL_CMD		= 0x70,	/* Call function command	 */
	UFPP_FCALL_RSLT_CMD	= 0x73,	/* Call function responce	 */
